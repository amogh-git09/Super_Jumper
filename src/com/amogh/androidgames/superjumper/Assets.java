...
public class Assets {
	...
	//public static TextureRegion hen;
	//public static TextureRegion friedChicken;
	//public static TextureRegion chickenTitle;
	...
	public static void load(GLGame game){
		...
		//hen = new TextureRegion(items, 289, 354, 57, 59);
		//friedChicken = new TextureRegion(items, 359, 354, 26, 51);
		//chickenTitle = new TextureRegion(items, 277, 430, 235, 39);
